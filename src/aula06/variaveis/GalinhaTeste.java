...
public class GalinhaTeste {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(galinha2.nome + ": " + galinha1.quantidadeOvos);
        System.out.println(galinha3.nome + ": " + galinha1.quantidadeOvos);
        System.out.println("TOTAL: " + Galinha.quantidadeTotalOvos);
    }
}
